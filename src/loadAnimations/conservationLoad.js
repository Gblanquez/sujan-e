...
const conservationLoad = async () => {
  ...
  const storyTitle = document.querySelector('.con_title')
  const storyLabel = document.querySelector('.con_label')
  ...
  gsap.set(splitLoadText.chars, { x: '-10%', y: '100%', rotateX: -72, rotateY: -45, rotateZ: -4, transformOrigin: 'top', transformStyle: 'preserve-3d' })
  ...
  gsap.set(splitTitle.chars, { x: '-10%', y: '100%', rotateX: -72, rotateY: -45, rotateZ: -4, transformOrigin: 'top', transformStyle: 'preserve-3d' })

  gsap.set(heroSection, { clipPath: 'polygon(45% 45%, 55% 45%, 55% 55%, 45% 55%)', opacity: 1 })
  ...
  loadTl
    .to(splitLoadText.chars, {
      ...
      duration: 2.4, ease: 'power4.out', stagger: { each: 0.03 }
    })
    .fromTo(loadNumb, { y: '100%' }, { y: '0%', duration: 1.2, ease: 'power2.out' }, '<+=0.3')
    .fromTo(loadBWrap, { scale: 0.7 }, { scale: 1, duration: 1, ease: 'power2.out' }, '<')
  ...
  exitTl
    .to(splitLoadText.chars, {
      x: '-10%', y: '-100%', rotateX: 72, rotateY: 45, rotateZ: 4,
      duration: 2.4, ease: 'power4.inOut', stagger: { each: 0.03 }
    })
    .to(loadNumb, { y: '100%', duration: 1, ease: 'power2.inOut' }, '<+=0.3')
    .to(loadBWrap, { scaleY: 0, duration: 1, ease: 'power2.inOut' }, '<+=0.2')
  ...
  revealTl
    ...
    .fromTo(storyLabel, { y: '100%', opacity: 0 }, { y: '0%', opacity: 1, duration: 1.2, ease: 'power4.out' }, '<+=0.2')
    .to([navWrapper, '.intro_s'], { opacity: 1, y: '0%', duration: 2.2, ease: 'power4.out' }, '<+=0.2')
...
export default conservationLoad